<div>
  <div class="flex items-center justify-between mb-3">
    <div class="flex gap-2">
      <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search offices..."
             class="border rounded px-2 py-1 text-sm" />
    </div>
    <button class="bg-blue-600 text-white px-3 py-1.5 rounded" wire:click="create">Add Office</button>
  </div>
