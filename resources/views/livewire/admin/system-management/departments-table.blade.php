<div>
  <div class="flex items-center justify-between mb-3">
    ...
    <button class="bg-blue-600 text-white px-3 py-1.5 rounded" wire:click="create">Add Department</button>
  </div>
  ...
  <div class="mt-3 space-y-2" wire:loading.flex wire:target="{{ $this->tableTargets }}" style="display:none">
